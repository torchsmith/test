...
// export default async function loadPage(params: any) {
...
// 			apiCall += `pages?slug=${params.slug[params.slug.length - 1]}`;
// 		} else {
// 			apiCall += `${params.slug[0]}?slug=${params.slug.slice(1).join('/')}`;
// 		}
